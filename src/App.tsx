      ...
      <main id="landing_screen" className="min-h-screen bg-slate-50 flex flex-col justify-between py-8 px-6 max-w-md mx-auto relative overflow-hidden">
        ...
        <div id="landing_actions_container" className="space-y-3">
          <button
            ...
            className="w-full py-4.5 px-4 bg-sky-600 hover:bg-sky-700 active:scale-[0.98] text-white font-extrabold rounded-2xl shadow-xl shadow-sky-300/60 ring-2 ring-sky-200/70 transition-all flex items-center justify-center gap-3 text-sm"
          >
